...
Opal.modules["opal/source_map/map"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $Map_to_h$1, $Map_to_json$2, $Map_as_json$3, $Map_to_s$4, $Map_to_data_uri_comment$5;
...
Opal.modules["opal/source_map/file"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$initialize', $File_initialize$1 = function $$initialize(fragments, file, source) {
      var $$2, self = this;
      ...
      self.file = file;
      self.source = source;
      self.names_map = $send($$($nesting, 'Hash'), 'new', [], ($$2 = function(hash, name){var self = $$2.$$s || this, $writer = nil;
    ...
    Opal.def(self, '$names', $File_names$5 = function $$names() {
      ...
      return (self.names = ($truthy($a = self.names) ? $a : (self.$absolute_mappings(), $send($send(self.names_map.$to_a(), 'sort_by', [], ($$6 = function(_, index){var self = $$6.$$s || this;
        ...
        return index;}, $$6.$$s = self, $$6.$$arity = 2, $$6)), 'map', [], ($$7 = function(name, _){var self = $$7.$$s || this;
    ...
    Opal.def(self, '$relative_mappings', $File_relative_mappings$9 = function $$relative_mappings() {
      var $a, $$10, self = this, reference_segment = nil, reference_name_index = nil;

      return (self.relative_mappings = ($truthy($a = self.relative_mappings) ? $a : ((reference_segment = [0, 0, 0, 0, 0]), (reference_name_index = 0), $send(self.$absolute_mappings(), 'map', [], ($$10 = function(absolute_mapping){var self = $$10.$$s || this, $$11, $writer = nil;
        ...
        $writer[$rb_minus($writer["length"], 1)];;
        return $send(absolute_mapping, 'map', [], ($$11 = function(absolute_segment){var self = $$11.$$s || this, $b, segment = nil;
    ...
    Opal.def(self, '$absolute_mappings', $File_absolute_mappings$12 = function $$absolute_mappings() {
      var $a, $$13, self = this, mappings = nil;

      return (self.absolute_mappings = ($truthy($a = self.absolute_mappings) ? $a : ((mappings = []), $send(self.$fragments_by_line(), 'each', [], ($$13 = function(raw_segments){var self = $$13.$$s || this, $$14, generated_column = nil, segments = nil;
        ...
        generated_column = 0;
        segments = [];
        $send(raw_segments, 'each', [], ($$14 = function($mlhs_tmp1){var self = $$14.$$s || this, $b, $c, generated_code = nil, fragment = nil;
        ...
        return mappings['$<<'](segments);}, $$13.$$s = self, $$13.$$arity = 1, $$13)), mappings)))
    ...
    return (Opal.def(self, '$fragments_by_line', $File_fragments_by_line$15 = function $$fragments_by_line() {
      ...
      raw_mappings = [[]];
      $send(self.$fragments(), 'flat_map', [], ($$16 = function(fragment){var self = $$16.$$s || this, $$17, fragment_code = nil, fragment_lines = nil;
        ...
        return $send(fragment_lines.$each(), 'with_index', [], ($$17 = function(fragment_line, index){var self = $$17.$$s || this, $a, raw_segment = nil;
...
Opal.modules["opal/source_map/index"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (Opal.def(self, '$map', $Index_map$2 = function $$map() {
      ...
      offset_line = 0;
      offset_column = 0;
      return $hash2(["version", "sections"], {"version": 3, "sections": $send(self.source_maps, 'map', [], ($$3 = function(source_map){var self = $$3.$$s || this, map = nil, generated_code = nil, new_lines_count = nil, last_line = nil;
...
Opal.modules["opal/source_map/vlq"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'BASE64_VALUES', $send($range(0, 64, true), 'inject', [$hash2([], {})], ($VLQ$1 = function(h, i){var self = $VLQ$1.$$s || this, $writer = nil;
    ...
    Opal.defs(self, '$encode', $VLQ_encode$2 = function $$encode(ary) {
      ...
      result = [];
      (function(){var $brk = Opal.new_brk(); try {return $send(ary, 'each', [], ($$3 = function(n){var self = $$3.$$s || this, $$4, vlq = nil;
        ...
        return (function(){var $brk = Opal.new_brk(); try {return $send(self, 'loop', [], ($$4 = function(){var self = $$4.$$s || this, digit = nil;
    ...
    Opal.defs(self, '$encode_mappings', $VLQ_encode_mappings$6 = function $$encode_mappings(ary) {
      ...
      return $send(ary, 'map', [], ($$7 = function(group){var self = $$7.$$s || this, $$8;
        ...
        return $send(group, 'map', [], ($$8 = function(segment){var self = $$8.$$s || this;
    ...
    Opal.defs(self, '$decode_mappings', $VLQ_decode_mappings$9 = function $$decode_mappings(str) {
      var $$10, self = this, mappings = nil;

      
      mappings = [];
      $send(str.$split(";"), 'each_with_index', [], ($$10 = function(group, index){var self = $$10.$$s || this, $$11, $writer = nil;
        ...
        $writer[$rb_minus($writer["length"], 1)];;
        return $send(group.$split(","), 'each', [], ($$11 = function(segment){var self = $$11.$$s || this;
